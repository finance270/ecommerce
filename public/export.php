...
switch ($report) {
    ...
    case 'product_profit':
        ...
        csvOut("laba_per_produk_{$stamp}.csv", [
            ...
            'PPN ' . Tax::PPN_PERSEN . '%', 'PPh ' . Tax::PPH_PERSEN . '%', 'Penjualan Bersih',
            'HPP', 'Laba', 'Marjin Laba %', 'Qty Tanpa HPP',
        ], array_map(static fn($r) => [
            ...
            round((float) $r['ppn'], 2), round((float) $r['pph'], 2),
            round((float) $r['penjualan'], 2),
            round((float) $r['hpp'], 2),
