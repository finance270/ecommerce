...
$rantai = [
    ['Pendapatan kotor',            (float) $total['kotor'],        false, 'Nilai produk sebelum potongan apa pun'],
    ['Potongan platform',           -abs((float) $total['potongan']), true,  'Diskon/subsidi yang ditanggung penjual'],
    ['Pengembalian (refund)',       -abs((float) $total['pengembalian']), true, 'Dana yang dikembalikan ke pembeli'],
